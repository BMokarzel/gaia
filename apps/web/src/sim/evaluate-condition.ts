...
//
// NOTE: this is a mirror of packages/core/src/sim/evaluate-condition.ts.
// We can't import from @topology/core in the web bundle because core has
// tree-sitter native deps. Keep the two files in sync.
//
// Returns:
...
import type { ConditionExpr } from '@topology/core';
